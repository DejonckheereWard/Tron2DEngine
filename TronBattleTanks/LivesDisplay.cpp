...
{
	if(eventName == "PlayerDeath" or eventName == "HealthChanged")
	{
		m_pTextComponent->SetText(m_Prefix + std::to_string(pGameObject->GetComponent<HealthComponent>()->GetExtraLives()));
	}
}
